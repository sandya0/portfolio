...
const Navbar = () => {
  ...
  return (
    ...
    bg-black text-white/80 py-28 gap-y-10 md:w-1/2 md:left-1/2">
        ...
        gap-8 md:flex-row'>
            <div className="font-light">
                ...
                <p className="text-xl tracking-widest lowercase text-pretty">Sandya@gmail.com</p>
            </div>
            <div className="font-light">
                <p className="tracking-wider text-white/50">Social Media
                </p>
    ...
    justify-center gap-1 transition-all duration-300 bg-black
    rounded-full cursor-pointer w-14 h-14 md:w-20 md:h-20 top-4
    right-10" 
    onClick={toggleMenu}
        style={
          showBurger
