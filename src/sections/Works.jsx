      ...
      <div onMouseMove={handleMouseMove} className="relative flex flex-col font-light">
        {projects.map((project, index) => (
          ...
          >
            ...
            {/* Title */}
            <div
              className="flex justify-between px-10 text-black 
            ...
            {/* Frameworks */}
            <div
              className="flex px-10 text-xs leading-loose
              uppercase transition-all duration-500 md:text-sm gap-x-5
            ...
            <div
              ...
              justify-center px-10 md:hidden h-[400px]"
            >
              <img
                src={project.bgImage}
        ...
        <div
          ref={previewRef}
          className="fixed -top-2/6 left-0 z-50 
          overflow-hidden border-8 border-black pointer-events-none
          w-[960px] md:block hidden opacity-0 scale-95"
        >
          {currentIndex !== null && (
            <img
